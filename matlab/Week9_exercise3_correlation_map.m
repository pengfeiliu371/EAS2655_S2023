...
data=table2array(readtable('./nino34.long.txt'));
...
hold on;
plot(T_ser,z_nino34);
plot([1948 2023],[0 0],'-','color','k');
plot([1948 2023],[1 1],'--','color','r');
plot([1948 2023],[-1 -1],'--','color','b');

plot([1948 2023],[2 2],'--','color','r');
plot([1948 2023],[-2 -2],'--','color','b');
...
diff=TMP_reconstruct(10,10,:)-TMP_1948_2022(10,10,:);
